...
public class ObjectFactory {
    ...
    private final static QName _GetReceiptUuid_QNAME = new QName("http://facturacion.finkok.com/cancel", "uuid");
    ...
    public JAXBElement<String> createCancelUsername(String value) {
        return new JAXBElement<String>(_SignCancelUsername_QNAME, String.class, Cancel.class, value);
    }
    ...
    public JAXBElement<String> createCancelPassword(String value) {
        return new JAXBElement<String>(_SignCancelPassword_QNAME, String.class, Cancel.class, value);
    }
    ...
    public JAXBElement<String> createOutCancelUsername(String value) {
        return new JAXBElement<String>(_SignCancelUsername_QNAME, String.class, OutCancel.class, value);
    }
    ...
    public JAXBElement<String> createOutCancelPassword(String value) {
        return new JAXBElement<String>(_SignCancelPassword_QNAME, String.class, OutCancel.class, value);
    }
    ...
    public JAXBElement<String> createGetReceiptUuid(String value) {
        return new JAXBElement<String>(_GetReceiptUuid_QNAME, String.class, GetReceipt.class, value);
    }
    ...
    public JAXBElement<String> createGetReceiptUsername(String value) {
        return new JAXBElement<String>(_SignCancelUsername_QNAME, String.class, GetReceipt.class, value);
    }
    ...
    public JAXBElement<String> createGetReceiptPassword(String value) {
        return new JAXBElement<String>(_SignCancelPassword_QNAME, String.class, GetReceipt.class, value);
    }
    ...
    public JAXBElement<String> createQueryPendingCancellationUuid(String value) {
        return new JAXBElement<String>(_GetReceiptUuid_QNAME, String.class, QueryPendingCancellation.class, value);
    }
    ...
    public JAXBElement<String> createQueryPendingCancellationUsername(String value) {
        return new JAXBElement<String>(_SignCancelUsername_QNAME, String.class, QueryPendingCancellation.class, value);
    }
    ...
    public JAXBElement<String> createQueryPendingCancellationPassword(String value) {
        return new JAXBElement<String>(_SignCancelPassword_QNAME, String.class, QueryPendingCancellation.class, value);
    }
    ...
    public JAXBElement<String> createCancelSignatureUsername(String value) {
        return new JAXBElement<String>(_SignCancelUsername_QNAME, String.class, CancelSignature.class, value);
    }
    ...
    public JAXBElement<String> createCancelSignaturePassword(String value) {
        return new JAXBElement<String>(_SignCancelPassword_QNAME, String.class, CancelSignature.class, value);
    }
